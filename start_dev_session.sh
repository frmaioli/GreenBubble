...
gvim WebSite/node_modules/admin-lte/GreenBubble/*.html WebSite/node_modules/admin-lte/GreenBubble/*.json &

#Open Chrome
google-chrome --disable-web-security --allow-file-access-from-files --user-data-dir WebSite/node_modules/admin-lte/GreenBubble/GB_dashboard.html WebSite/node_modules/admin-lte/GreenBubble/GB_cfg.html WebSite/node_modules/admin-lte/GreenBubble/GB_charts.html &
